...
/**
 * DeleteCommentPublic200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeleteCommentPublic200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteCommentPublic_200_response';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('hard_removed', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['hard_removed'] === null) {
            $invalidProperties[] = "'hard_removed' can't be null";
        }
     ...
     * Gets comment
     *
     * @return \OpenAPI\Client\Model\PickFCommentIsDeletedOrCommentHTMLOrCommenterNameOrUserId|null
     */
     ...
     * Sets comment
     *
     * @param \OpenAPI\Client\Model\PickFCommentIsDeletedOrCommentHTMLOrCommenterNameOrUserId|null $comment comment
     *
     * @return self
     */
     ...
     * @return bool
     */
    public function getHardRemoved()
    {
        return $this->container['hard_removed'];
    }

    /**
     * Sets hard_removed
     *
     * @param bool $hard_removed hard_removed
     *
     * @return self
     */
    public function setHardRemoved($hard_removed)
    {
        if (is_null($hard_removed)) {
            throw new \InvalidArgumentException('non-nullable hard_removed cannot be null');
        }
        $this->container['hard_removed'] = $hard_removed;
