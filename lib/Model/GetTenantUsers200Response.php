...
/**
 * GetTenantUsers200Response Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetTenantUsers200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetTenantUsers_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'tenant_users' => '\FastComments\Client\Model\User[]',
        'reason' => 'string',
        'code' => 'string',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tenant_users', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tenant_users'] === null) {
            $invalidProperties[] = "'tenant_users' can't be null";
        }
     ...
     * Gets tenant_users
     *
     * @return \FastComments\Client\Model\User[]
     */
    public function getTenantUsers()
    {
        return $this->container['tenant_users'];
    }

    /**
     * Sets tenant_users
     *
     * @param \FastComments\Client\Model\User[] $tenant_users tenant_users
     *
     * @return self
     */
    public function setTenantUsers($tenant_users)
    {
        if (is_null($tenant_users)) {
            throw new \InvalidArgumentException('non-nullable tenant_users cannot be null');
        }
        $this->container['tenant_users'] = $tenant_users;
