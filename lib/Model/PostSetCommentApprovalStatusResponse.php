...
/**
 * PostSetCommentApprovalStatusResponse Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostSetCommentApprovalStatusResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostSetCommentApprovalStatusResponse';
    ...
    protected static $setters = [
        'did_reset_flagged_count' => 'setDidResetFlaggedCount',
        'status' => 'setStatus',
        'reason' => 'setReason',
        'code' => 'setCode',
    ...
    protected static $getters = [
        'did_reset_flagged_count' => 'getDidResetFlaggedCount',
        'status' => 'getStatus',
        'reason' => 'getReason',
        'code' => 'getCode',
    ...
    {
        $this->setIfExists('did_reset_flagged_count', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets did_reset_flagged_count
     *
     * @return bool|null
     */
    public function getDidResetFlaggedCount()
    {
        return $this->container['did_reset_flagged_count'];
    }

    /**
     * Sets did_reset_flagged_count
     *
     * @param bool|null $did_reset_flagged_count did_reset_flagged_count
     *
     * @return self
     */
    public function setDidResetFlaggedCount($did_reset_flagged_count)
    {
        if (is_null($did_reset_flagged_count)) {
            throw new \InvalidArgumentException('non-nullable did_reset_flagged_count cannot be null');
        }
        $this->container['did_reset_flagged_count'] = $did_reset_flagged_count;
