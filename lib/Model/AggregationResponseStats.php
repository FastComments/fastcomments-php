...
/**
 * AggregationResponseStats Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class AggregationResponseStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AggregationResponse_stats';
    ...
    {
        $this->setIfExists('time_ms', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($time_ms)) {
            throw new \InvalidArgumentException('non-nullable time_ms cannot be null');
        }
