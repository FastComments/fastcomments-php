...
/**
 * GetVotesForUser200Response Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetVotesForUser200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetVotesForUser_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'applied_authorized_votes' => '\FastComments\Client\Model\PublicVote[]',
        'applied_anonymous_votes' => '\FastComments\Client\Model\PublicVote[]',
        'pending_votes' => '\FastComments\Client\Model\PublicVote[]',
        'reason' => 'string',
        'code' => 'string',
    ...
    protected static array $openAPINullables = [
        'status' => false,
        'applied_authorized_votes' => false,
        'applied_anonymous_votes' => false,
        'pending_votes' => false,
        'reason' => false,
        'code' => false,
    ...
    protected static $setters = [
        'status' => 'setStatus',
        'applied_authorized_votes' => 'setAppliedAuthorizedVotes',
        'applied_anonymous_votes' => 'setAppliedAnonymousVotes',
        'pending_votes' => 'setPendingVotes',
        'reason' => 'setReason',
        'code' => 'setCode',
    ...
    protected static $getters = [
        'status' => 'getStatus',
        'applied_authorized_votes' => 'getAppliedAuthorizedVotes',
        'applied_anonymous_votes' => 'getAppliedAnonymousVotes',
        'pending_votes' => 'getPendingVotes',
        'reason' => 'getReason',
        'code' => 'getCode',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('applied_authorized_votes', $data ?? [], null);
        $this->setIfExists('applied_anonymous_votes', $data ?? [], null);
        $this->setIfExists('pending_votes', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['applied_authorized_votes'] === null) {
            $invalidProperties[] = "'applied_authorized_votes' can't be null";
        }
        if ($this->container['applied_anonymous_votes'] === null) {
            $invalidProperties[] = "'applied_anonymous_votes' can't be null";
        }
        if ($this->container['pending_votes'] === null) {
            $invalidProperties[] = "'pending_votes' can't be null";
        }
    ...
    /**
     * Gets applied_authorized_votes
     *
     * @return \FastComments\Client\Model\PublicVote[]
     */
    public function getAppliedAuthorizedVotes()
    {
        return $this->container['applied_authorized_votes'];
    }

    /**
     * Sets applied_authorized_votes
     *
     * @param \FastComments\Client\Model\PublicVote[] $applied_authorized_votes applied_authorized_votes
     *
     * @return self
     */
    public function setAppliedAuthorizedVotes($applied_authorized_votes)
    {
        if (is_null($applied_authorized_votes)) {
            throw new \InvalidArgumentException('non-nullable applied_authorized_votes cannot be null');
        }
        $this->container['applied_authorized_votes'] = $applied_authorized_votes;

        return $this;
    }

    /**
     * Gets applied_anonymous_votes
     *
     * @return \FastComments\Client\Model\PublicVote[]
     */
    public function getAppliedAnonymousVotes()
    {
        return $this->container['applied_anonymous_votes'];
    }

    /**
     * Sets applied_anonymous_votes
     *
     * @param \FastComments\Client\Model\PublicVote[] $applied_anonymous_votes applied_anonymous_votes
     *
     * @return self
     */
    public function setAppliedAnonymousVotes($applied_anonymous_votes)
    {
        if (is_null($applied_anonymous_votes)) {
            throw new \InvalidArgumentException('non-nullable applied_anonymous_votes cannot be null');
        }
        $this->container['applied_anonymous_votes'] = $applied_anonymous_votes;
    ...
    {
        return $this->container['pending_votes'];
    }

    /**
     * Sets pending_votes
     *
     * @param \FastComments\Client\Model\PublicVote[] $pending_votes pending_votes
     *
     * @return self
     */
    public function setPendingVotes($pending_votes)
    {
        if (is_null($pending_votes)) {
            throw new \InvalidArgumentException('non-nullable pending_votes cannot be null');
        }
        $this->container['pending_votes'] = $pending_votes;
