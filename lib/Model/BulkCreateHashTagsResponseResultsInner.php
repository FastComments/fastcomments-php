...
/**
 * BulkCreateHashTagsResponseResultsInner Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class BulkCreateHashTagsResponseResultsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BulkCreateHashTagsResponse_results_inner';
    ...
    protected static $openAPITypes = [
        ...
        'hash_tag' => '\FastComments\Client\Model\TenantHashTag',
        'reason' => 'string',
        'code' => 'string',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('hash_tag', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['hash_tag'] === null) {
            $invalidProperties[] = "'hash_tag' can't be null";
        }
     ...
     * Gets hash_tag
     *
     * @return \FastComments\Client\Model\TenantHashTag
     */
    public function getHashTag()
    {
        return $this->container['hash_tag'];
    }

    /**
     * Sets hash_tag
     *
     * @param \FastComments\Client\Model\TenantHashTag $hash_tag hash_tag
     *
     * @return self
     */
    ...
    {
        if (is_null($hash_tag)) {
            throw new \InvalidArgumentException('non-nullable hash_tag cannot be null');
        }
        $this->container['hash_tag'] = $hash_tag;
