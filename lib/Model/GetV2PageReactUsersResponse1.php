...
/**
 * GetV2PageReactUsersResponse1 Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetV2PageReactUsersResponse1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetV2PageReactUsersResponse_1';
    ...
    {
        $this->setIfExists('user_names', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['user_names'] === null) {
            $invalidProperties[] = "'user_names' can't be null";
        }
    ...
    public function setUserNames($user_names)
    {
        if (is_null($user_names)) {
            throw new \InvalidArgumentException('non-nullable user_names cannot be null');
        }
