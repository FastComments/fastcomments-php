...
/**
 * CreateTenantUser200Response Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateTenantUser200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateTenantUser_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'tenant_user' => '\FastComments\Client\Model\User',
        'reason' => 'string',
        'code' => 'string',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tenant_user', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tenant_user'] === null) {
            $invalidProperties[] = "'tenant_user' can't be null";
        }
    ...
    {
        return $this->container['tenant_user'];
    }

    /**
     * Sets tenant_user
     *
     * @param \FastComments\Client\Model\User $tenant_user tenant_user
     *
     * @return self
     */
    public function setTenantUser($tenant_user)
    {
        if (is_null($tenant_user)) {
            throw new \InvalidArgumentException('non-nullable tenant_user cannot be null');
        }
        $this->container['tenant_user'] = $tenant_user;
