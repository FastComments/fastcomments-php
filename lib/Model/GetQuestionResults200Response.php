...
/**
 * GetQuestionResults200Response Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetQuestionResults200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetQuestionResults_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'question_results' => '\FastComments\Client\Model\QuestionResult[]',
        'reason' => 'string',
        'code' => 'string',
    ...
    protected static $setters = [
        'status' => 'setStatus',
        'question_results' => 'setQuestionResults',
        'reason' => 'setReason',
        'code' => 'setCode',
    ...
    protected static $getters = [
        'status' => 'getStatus',
        'question_results' => 'getQuestionResults',
        'reason' => 'getReason',
        'code' => 'getCode',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('question_results', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['question_results'] === null) {
            $invalidProperties[] = "'question_results' can't be null";
        }
    ...
    /**
     * Gets question_results
     *
     * @return \FastComments\Client\Model\QuestionResult[]
     */
    public function getQuestionResults()
    {
        return $this->container['question_results'];
    }

    /**
     * Sets question_results
     *
     * @param \FastComments\Client\Model\QuestionResult[] $question_results question_results
     *
     * @return self
     */
    public function setQuestionResults($question_results)
    {
        if (is_null($question_results)) {
            throw new \InvalidArgumentException('non-nullable question_results cannot be null');
        }
        $this->container['question_results'] = $question_results;
