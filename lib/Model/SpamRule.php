 ...
 */
class SpamRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SpamRule';
    ...
    public const ACTIONS_SPAM = 'spam';
    public const ACTIONS_NOT_SPAM = 'not-spam';
    public const ACTIONS_IGNORE_REPEAT = 'ignore-repeat';
    ...
    public function getActionsAllowableValues()
    {
        return [
            self::ACTIONS_SPAM,
            self::ACTIONS_NOT_SPAM,
            self::ACTIONS_IGNORE_REPEAT,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('comment_contains', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $comment_contains comment_contains
     *
     * @return self
     */
    public function setCommentContains($comment_contains)
    {
        if (is_null($comment_contains)) {
            throw new \InvalidArgumentException('non-nullable comment_contains cannot be null');
        }
