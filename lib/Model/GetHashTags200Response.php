...
/**
 * GetHashTags200Response Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetHashTags200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetHashTags_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'hash_tags' => '\FastComments\Client\Model\TenantHashTag[]',
        'reason' => 'string',
        'code' => 'string',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['hash_tags'] === null) {
            $invalidProperties[] = "'hash_tags' can't be null";
        }
     ...
     * Sets hash_tags
     *
     * @param \FastComments\Client\Model\TenantHashTag[] $hash_tags hash_tags
     *
     * @return self
     */
