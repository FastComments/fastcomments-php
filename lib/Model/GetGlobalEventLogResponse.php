...
/**
 * GetGlobalEventLogResponse Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetGlobalEventLogResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetGlobalEventLogResponse';
    ...
    */
     ...
     * Gets events
     *
     * @return \FastComments\Client\Model\EventLogEntry[]
     */
     ...
     * Sets events
     *
     * @param \FastComments\Client\Model\EventLogEntry[] $events events
     *
     * @return self
     */
