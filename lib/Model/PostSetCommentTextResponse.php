...
/**
 * PostSetCommentTextResponse Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostSetCommentTextResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostSetCommentTextResponse';
    ...
    protected static $setters = [
        'new_comment_text_html' => 'setNewCommentTextHtml',
        'status' => 'setStatus',
        'reason' => 'setReason',
        'code' => 'setCode',
    ...
    protected static $getters = [
        'new_comment_text_html' => 'getNewCommentTextHtml',
        'status' => 'getStatus',
        'reason' => 'getReason',
        'code' => 'getCode',
    ...
    {
        $this->setIfExists('new_comment_text_html', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['new_comment_text_html'] === null) {
            $invalidProperties[] = "'new_comment_text_html' can't be null";
        }
    ...
    /**
     * Gets new_comment_text_html
     *
     * @return string
     */
    public function getNewCommentTextHtml()
    {
        return $this->container['new_comment_text_html'];
    }

    /**
     * Sets new_comment_text_html
     *
     * @param string $new_comment_text_html new_comment_text_html
     *
     * @return self
     */
    public function setNewCommentTextHtml($new_comment_text_html)
    {
        if (is_null($new_comment_text_html)) {
            throw new \InvalidArgumentException('non-nullable new_comment_text_html cannot be null');
        }
        $this->container['new_comment_text_html'] = $new_comment_text_html;
