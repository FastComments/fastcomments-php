...
/**
 * UpdateUserNotificationCommentSubscriptionStatusResponse Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateUserNotificationCommentSubscriptionStatusResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateUserNotificationCommentSubscriptionStatusResponse';
    ...
    public const NOTE_IGNORED_SINCE_IMPERSONATED = 'ignored-since-impersonated';
    public const NOTE_DEMO_NOOP = 'demo-noop';
     ...
     * @return string[]
     */
    public function getNoteAllowableValues()
    {
        return [
            self::NOTE_IGNORED_SINCE_IMPERSONATED,
            self::NOTE_DEMO_NOOP,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('matched_count', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['matched_count'] === null) {
            $invalidProperties[] = "'matched_count' can't be null";
        }
        if ($this->container['modified_count'] === null) {
            $invalidProperties[] = "'modified_count' can't be null";
        }
        if ($this->container['note'] === null) {
            $invalidProperties[] = "'note' can't be null";
        }
        $allowedValues = $this->getNoteAllowableValues();
        if (!is_null($this->container['note']) && !in_array($this->container['note'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'note', must be one of '%s'",
                $this->container['note'],
    ...
    {
        return $this->container['matched_count'];
    }
    ...
    {
        if (is_null($matched_count)) {
            throw new \InvalidArgumentException('non-nullable matched_count cannot be null');
        }
        $this->container['matched_count'] = $matched_count;
    ...
    public function setNote($note)
    {
        ...
        $allowedValues = $this->getNoteAllowableValues();
        if (!in_array($note, $allowedValues, true)) {
