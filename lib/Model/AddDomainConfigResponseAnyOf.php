...
/**
 * AddDomainConfigResponseAnyOf Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddDomainConfigResponseAnyOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AddDomainConfigResponse_anyOf';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['configuration'] === null && !$this->isNullableSetToNull('configuration')) {
            $invalidProperties[] = "'configuration' is required";
        }
