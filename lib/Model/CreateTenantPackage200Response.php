...
/**
 * CreateTenantPackage200Response Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateTenantPackage200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateTenantPackage_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'tenant_package' => '\FastComments\Client\Model\TenantPackage',
        'reason' => 'string',
        'code' => 'string',
    ...
    protected static $setters = [
        'status' => 'setStatus',
        'tenant_package' => 'setTenantPackage',
        'reason' => 'setReason',
        'code' => 'setCode',
    ...
    protected static $getters = [
        'status' => 'getStatus',
        'tenant_package' => 'getTenantPackage',
        'reason' => 'getReason',
        'code' => 'getCode',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tenant_package', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tenant_package'] === null) {
            $invalidProperties[] = "'tenant_package' can't be null";
        }
     ...
     */
    public function getTenantPackage()
    {
        return $this->container['tenant_package'];
    }

    /**
     * Sets tenant_package
     *
     * @param \FastComments\Client\Model\TenantPackage $tenant_package tenant_package
     *
     * @return self
     */
    public function setTenantPackage($tenant_package)
    {
        if (is_null($tenant_package)) {
            throw new \InvalidArgumentException('non-nullable tenant_package cannot be null');
        }
        $this->container['tenant_package'] = $tenant_package;
