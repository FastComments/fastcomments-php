 ...
 */
class APIAuditLog implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'APIAuditLog';
    ...
    */
    ...
    public function setObjectDetails($object_details)
    {
        if (is_null($object_details)) {
            array_push($this->openAPINullablesSetToNull, 'object_details');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('object_details', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
