...
/**
 * GetDomainConfigsResponseAnyOf Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetDomainConfigsResponseAnyOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GetDomainConfigsResponse_anyOf';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['configurations'] === null && !$this->isNullableSetToNull('configurations')) {
            $invalidProperties[] = "'configurations' is required";
        }
     ...
     * Sets configurations
     *
     * @param mixed|null $configurations configurations
     *
     * @return self
     */
