...
class HeaderAccountNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['messages_by_locale'] === null) {
            $invalidProperties[] = "'messages_by_locale' can't be null";
        }
     ...
     *
     * @param array<string,string> $messages_by_locale Construct a type with a set of properties K of type T
     *
     * @return self
     */
     ...
     * Sets dates
     *
     * @param array<string,string> $dates Construct a type with a set of properties K of type T
     *
     * @return self
     */
