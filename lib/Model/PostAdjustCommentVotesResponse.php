...
/**
 * PostAdjustCommentVotesResponse Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostAdjustCommentVotesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostAdjustCommentVotesResponse';
    ...
    protected static $setters = [
        'status' => 'setStatus',
        'new_comment_votes' => 'setNewCommentVotes',
        'reason' => 'setReason',
        'code' => 'setCode',
    ...
    protected static $getters = [
        'status' => 'getStatus',
        'new_comment_votes' => 'getNewCommentVotes',
        'reason' => 'getReason',
        'code' => 'getCode',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('new_comment_votes', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['new_comment_votes'] === null) {
            $invalidProperties[] = "'new_comment_votes' can't be null";
        }
    ...
    /**
     * Gets new_comment_votes
     *
     * @return int
     */
    public function getNewCommentVotes()
    {
        return $this->container['new_comment_votes'];
    }

    /**
     * Sets new_comment_votes
     *
     * @param int $new_comment_votes new_comment_votes
     *
     * @return self
     */
    public function setNewCommentVotes($new_comment_votes)
    {
        if (is_null($new_comment_votes)) {
            throw new \InvalidArgumentException('non-nullable new_comment_votes cannot be null');
        }
        $this->container['new_comment_votes'] = $new_comment_votes;
