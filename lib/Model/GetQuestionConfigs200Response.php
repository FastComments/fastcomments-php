...
/**
 * GetQuestionConfigs200Response Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetQuestionConfigs200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetQuestionConfigs_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'question_configs' => '\FastComments\Client\Model\QuestionConfig[]',
        'reason' => 'string',
        'code' => 'string',
    ...
    protected static $setters = [
        'status' => 'setStatus',
        'question_configs' => 'setQuestionConfigs',
        'reason' => 'setReason',
        'code' => 'setCode',
    ...
    protected static $getters = [
        'status' => 'getStatus',
        'question_configs' => 'getQuestionConfigs',
        'reason' => 'getReason',
        'code' => 'getCode',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('question_configs', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['question_configs'] === null) {
            $invalidProperties[] = "'question_configs' can't be null";
        }
    ...
    /**
     * Gets question_configs
     *
     * @return \FastComments\Client\Model\QuestionConfig[]
     */
    public function getQuestionConfigs()
    {
        return $this->container['question_configs'];
    }

    /**
     * Sets question_configs
     *
     * @param \FastComments\Client\Model\QuestionConfig[] $question_configs question_configs
     *
     * @return self
     */
    public function setQuestionConfigs($question_configs)
    {
        if (is_null($question_configs)) {
            throw new \InvalidArgumentException('non-nullable question_configs cannot be null');
        }
        $this->container['question_configs'] = $question_configs;
