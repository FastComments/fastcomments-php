...
/**
 * GetPendingWebhookEvents200Response Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetPendingWebhookEvents200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetPendingWebhookEvents_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'pending_webhook_events' => '\FastComments\Client\Model\PendingCommentToSyncOutbound[]',
        'reason' => 'string',
        'code' => 'string',
    ...
    protected static $setters = [
        'status' => 'setStatus',
        'pending_webhook_events' => 'setPendingWebhookEvents',
        'reason' => 'setReason',
        'code' => 'setCode',
    ...
    protected static $getters = [
        'status' => 'getStatus',
        'pending_webhook_events' => 'getPendingWebhookEvents',
        'reason' => 'getReason',
        'code' => 'getCode',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('pending_webhook_events', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pending_webhook_events'] === null) {
            $invalidProperties[] = "'pending_webhook_events' can't be null";
        }
    ...
    /**
     * Gets pending_webhook_events
     *
     * @return \FastComments\Client\Model\PendingCommentToSyncOutbound[]
     */
    public function getPendingWebhookEvents()
    {
        return $this->container['pending_webhook_events'];
    }

    /**
     * Sets pending_webhook_events
     *
     * @param \FastComments\Client\Model\PendingCommentToSyncOutbound[] $pending_webhook_events pending_webhook_events
     *
     * @return self
     */
    public function setPendingWebhookEvents($pending_webhook_events)
    {
        if (is_null($pending_webhook_events)) {
            throw new \InvalidArgumentException('non-nullable pending_webhook_events cannot be null');
        }
        $this->container['pending_webhook_events'] = $pending_webhook_events;
