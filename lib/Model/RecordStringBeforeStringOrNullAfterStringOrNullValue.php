...
/**
 * RecordStringBeforeStringOrNullAfterStringOrNullValue Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class RecordStringBeforeStringOrNullAfterStringOrNullValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Record_string__before_string_or_null__after_string_or_null___value';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['after'] === null && !$this->isNullableSetToNull('after')) {
            $invalidProperties[] = "'after' is required";
        }
        if ($this->container['before'] === null && !$this->isNullableSetToNull('before')) {
            $invalidProperties[] = "'before' is required";
        }
