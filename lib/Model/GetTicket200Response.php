...
/**
 * GetTicket200Response Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetTicket200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetTicket_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'ticket' => '\FastComments\Client\Model\APITicketDetail',
    ...
    protected static $setters = [
        'status' => 'setStatus',
        'ticket' => 'setTicket',
        'available_states' => 'setAvailableStates',
        'reason' => 'setReason',
        'code' => 'setCode',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('available_states', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['available_states'] === null) {
            $invalidProperties[] = "'available_states' can't be null";
        }
     ...
     * Gets ticket
     *
     * @return \FastComments\Client\Model\APITicketDetail
     */
     ...
     * Sets ticket
     *
     * @param \FastComments\Client\Model\APITicketDetail $ticket ticket
     *
     * @return self
     */
    ...
    /**
     * Gets available_states
     *
     * @return float[]
     */
    public function getAvailableStates()
    {
        return $this->container['available_states'];
    }

    /**
     * Sets available_states
     *
     * @param float[] $available_states available_states
     *
     * @return self
     */
    public function setAvailableStates($available_states)
    {
        if (is_null($available_states)) {
            throw new \InvalidArgumentException('non-nullable available_states cannot be null');
        }
        $this->container['available_states'] = $available_states;
