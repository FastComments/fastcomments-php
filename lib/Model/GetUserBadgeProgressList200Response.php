...
/**
 * GetUserBadgeProgressList200Response Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetUserBadgeProgressList200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetUserBadgeProgressList_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'user_badge_progresses' => '\FastComments\Client\Model\UserBadgeProgress[]',
        'reason' => 'string',
        'code' => 'string',
    ...
    protected static $setters = [
        'status' => 'setStatus',
        'user_badge_progresses' => 'setUserBadgeProgresses',
        'reason' => 'setReason',
        'code' => 'setCode',
    ...
    protected static $getters = [
        'status' => 'getStatus',
        'user_badge_progresses' => 'getUserBadgeProgresses',
        'reason' => 'getReason',
        'code' => 'getCode',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('user_badge_progresses', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['user_badge_progresses'] === null) {
            $invalidProperties[] = "'user_badge_progresses' can't be null";
        }
    ...
    /**
     * Gets user_badge_progresses
     *
     * @return \FastComments\Client\Model\UserBadgeProgress[]
     */
    public function getUserBadgeProgresses()
    {
        return $this->container['user_badge_progresses'];
    }

    /**
     * Sets user_badge_progresses
     *
     * @param \FastComments\Client\Model\UserBadgeProgress[] $user_badge_progresses user_badge_progresses
     *
     * @return self
     */
    public function setUserBadgeProgresses($user_badge_progresses)
    {
        if (is_null($user_badge_progresses)) {
            throw new \InvalidArgumentException('non-nullable user_badge_progresses cannot be null');
        }
        $this->container['user_badge_progresses'] = $user_badge_progresses;
