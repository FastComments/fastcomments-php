...
/**
 * GetEmailTemplateRenderErrors200Response Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetEmailTemplateRenderErrors200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetEmailTemplateRenderErrors_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'render_errors' => '\FastComments\Client\Model\EmailTemplateRenderErrorResponse[]',
        'reason' => 'string',
        'code' => 'string',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('render_errors', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['render_errors'] === null) {
            $invalidProperties[] = "'render_errors' can't be null";
        }
     ...
     * Gets render_errors
     *
     * @return \FastComments\Client\Model\EmailTemplateRenderErrorResponse[]
     */
    public function getRenderErrors()
    {
        return $this->container['render_errors'];
    }

    /**
     * Sets render_errors
     *
     * @param \FastComments\Client\Model\EmailTemplateRenderErrorResponse[] $render_errors render_errors
     *
     * @return self
     */
    public function setRenderErrors($render_errors)
    {
        if (is_null($render_errors)) {
            throw new \InvalidArgumentException('non-nullable render_errors cannot be null');
        }
        $this->container['render_errors'] = $render_errors;
