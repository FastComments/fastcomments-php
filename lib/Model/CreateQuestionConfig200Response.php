...
/**
 * CreateQuestionConfig200Response Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateQuestionConfig200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateQuestionConfig_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'question_config' => '\FastComments\Client\Model\QuestionConfig',
        'reason' => 'string',
        'code' => 'string',
    ...
    protected static $setters = [
        'status' => 'setStatus',
        'question_config' => 'setQuestionConfig',
        'reason' => 'setReason',
        'code' => 'setCode',
    ...
    protected static $getters = [
        'status' => 'getStatus',
        'question_config' => 'getQuestionConfig',
        'reason' => 'getReason',
        'code' => 'getCode',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('question_config', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['question_config'] === null) {
            $invalidProperties[] = "'question_config' can't be null";
        }
    ...
    /**
     * Gets question_config
     *
     * @return \FastComments\Client\Model\QuestionConfig
     */
    public function getQuestionConfig()
    {
        return $this->container['question_config'];
    }

    /**
     * Sets question_config
     *
     * @param \FastComments\Client\Model\QuestionConfig $question_config question_config
     *
     * @return self
     */
    public function setQuestionConfig($question_config)
    {
        if (is_null($question_config)) {
            throw new \InvalidArgumentException('non-nullable question_config cannot be null');
        }
        $this->container['question_config'] = $question_config;
