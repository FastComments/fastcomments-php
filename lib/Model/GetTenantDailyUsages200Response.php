...
/**
 * GetTenantDailyUsages200Response Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetTenantDailyUsages200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetTenantDailyUsages_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'tenant_daily_usages' => '\FastComments\Client\Model\APITenantDailyUsage[]',
        'reason' => 'string',
        'code' => 'string',
    ...
    protected static $setters = [
        'status' => 'setStatus',
        'tenant_daily_usages' => 'setTenantDailyUsages',
        'reason' => 'setReason',
        'code' => 'setCode',
    ...
    protected static $getters = [
        'status' => 'getStatus',
        'tenant_daily_usages' => 'getTenantDailyUsages',
        'reason' => 'getReason',
        'code' => 'getCode',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tenant_daily_usages', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tenant_daily_usages'] === null) {
            $invalidProperties[] = "'tenant_daily_usages' can't be null";
        }
    ...
    /**
     * Gets tenant_daily_usages
     *
     * @return \FastComments\Client\Model\APITenantDailyUsage[]
     */
    public function getTenantDailyUsages()
    {
        return $this->container['tenant_daily_usages'];
    }

    /**
     * Sets tenant_daily_usages
     *
     * @param \FastComments\Client\Model\APITenantDailyUsage[] $tenant_daily_usages tenant_daily_usages
     *
     * @return self
     */
    public function setTenantDailyUsages($tenant_daily_usages)
    {
        if (is_null($tenant_daily_usages)) {
            throw new \InvalidArgumentException('non-nullable tenant_daily_usages cannot be null');
        }
        $this->container['tenant_daily_usages'] = $tenant_daily_usages;
