...
/**
 * GetV2PageReactsResponse Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetV2PageReactsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetV2PageReactsResponse';
    ...
    {
        $this->setIfExists('reacted_ids', $data ?? [], null);
    ...
    */
     ...
     * @return string[]|null
     */
    public function getReactedIds()
    {
        return $this->container['reacted_ids'];
    }

    /**
     * Sets reacted_ids
     *
     * @param string[]|null $reacted_ids reacted_ids
     *
     * @return self
     */
    public function setReactedIds($reacted_ids)
    {
        if (is_null($reacted_ids)) {
            throw new \InvalidArgumentException('non-nullable reacted_ids cannot be null');
        }
        $this->container['reacted_ids'] = $reacted_ids;
     ...
     * Sets counts
     *
     * @param array<string,float>|null $counts Construct a type with a set of properties K of type T
     *
     * @return self
     */
