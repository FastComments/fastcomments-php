...
/**
 * CreateModerator200Response Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateModerator200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateModerator_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'moderator' => '\FastComments\Client\Model\Moderator',
        'reason' => 'string',
        'code' => 'string',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('moderator', $data ?? [], null);
    ...
    */
     ...
     * Gets moderator
     *
     * @return \FastComments\Client\Model\Moderator
     */
     ...
     * Sets moderator
     *
     * @param \FastComments\Client\Model\Moderator $moderator moderator
     *
     * @return self
     */
    public function setModerator($moderator)
    {
        if (is_null($moderator)) {
            throw new \InvalidArgumentException('non-nullable moderator cannot be null');
        }
