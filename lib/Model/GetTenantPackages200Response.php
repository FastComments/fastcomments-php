...
/**
 * GetTenantPackages200Response Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetTenantPackages200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetTenantPackages_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'tenant_packages' => '\FastComments\Client\Model\TenantPackage[]',
        'reason' => 'string',
        'code' => 'string',
    ...
    protected static $setters = [
        'status' => 'setStatus',
        'tenant_packages' => 'setTenantPackages',
        'reason' => 'setReason',
        'code' => 'setCode',
    ...
    protected static $getters = [
        'status' => 'getStatus',
        'tenant_packages' => 'getTenantPackages',
        'reason' => 'getReason',
        'code' => 'getCode',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tenant_packages', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tenant_packages'] === null) {
            $invalidProperties[] = "'tenant_packages' can't be null";
        }
    ...
    /**
     * Gets tenant_packages
     *
     * @return \FastComments\Client\Model\TenantPackage[]
     */
    public function getTenantPackages()
    {
        return $this->container['tenant_packages'];
    }

    /**
     * Sets tenant_packages
     *
     * @param \FastComments\Client\Model\TenantPackage[] $tenant_packages tenant_packages
     *
     * @return self
     */
    public function setTenantPackages($tenant_packages)
    {
        if (is_null($tenant_packages)) {
            throw new \InvalidArgumentException('non-nullable tenant_packages cannot be null');
        }
        $this->container['tenant_packages'] = $tenant_packages;
