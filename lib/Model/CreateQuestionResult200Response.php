...
/**
 * CreateQuestionResult200Response Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateQuestionResult200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateQuestionResult_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'question_result' => '\FastComments\Client\Model\QuestionResult',
        'reason' => 'string',
        'code' => 'string',
    ...
    protected static $setters = [
        'status' => 'setStatus',
        'question_result' => 'setQuestionResult',
        'reason' => 'setReason',
        'code' => 'setCode',
    ...
    protected static $getters = [
        'status' => 'getStatus',
        'question_result' => 'getQuestionResult',
        'reason' => 'getReason',
        'code' => 'getCode',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('question_result', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['question_result'] === null) {
            $invalidProperties[] = "'question_result' can't be null";
        }
    ...
    /**
     * Gets question_result
     *
     * @return \FastComments\Client\Model\QuestionResult
     */
    public function getQuestionResult()
    {
        return $this->container['question_result'];
    }

    /**
     * Sets question_result
     *
     * @param \FastComments\Client\Model\QuestionResult $question_result question_result
     *
     * @return self
     */
    public function setQuestionResult($question_result)
    {
        if (is_null($question_result)) {
            throw new \InvalidArgumentException('non-nullable question_result cannot be null');
        }
        $this->container['question_result'] = $question_result;
