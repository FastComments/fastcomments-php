...
/**
 * GetUserBadges200Response Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetUserBadges200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetUserBadges_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'user_badges' => '\FastComments\Client\Model\UserBadge[]',
        'reason' => 'string',
        'code' => 'string',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('user_badges', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['user_badges'] === null) {
            $invalidProperties[] = "'user_badges' can't be null";
        }
    ...
    {
        return $this->container['user_badges'];
    }

    /**
     * Sets user_badges
     *
     * @param \FastComments\Client\Model\UserBadge[] $user_badges user_badges
     *
     * @return self
     */
    public function setUserBadges($user_badges)
    {
        if (is_null($user_badges)) {
            throw new \InvalidArgumentException('non-nullable user_badges cannot be null');
        }
        $this->container['user_badges'] = $user_badges;
