...
/**
 * ReactFeedPostPublic200Response Class Doc Comment
 *
 * @category Class
 * @package  FastComments\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReactFeedPostPublic200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReactFeedPostPublic_200_response';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('react_type', $data ?? [], null);
        $this->setIfExists('is_undo', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['react_type'] === null) {
            $invalidProperties[] = "'react_type' can't be null";
        }
        if ($this->container['is_undo'] === null) {
            $invalidProperties[] = "'is_undo' can't be null";
        }
     ...
     * @return string
     */
    public function getReactType()
    {
        return $this->container['react_type'];
    }

    /**
     * Sets react_type
     *
     * @param string $react_type react_type
     *
     * @return self
     */
    public function setReactType($react_type)
    {
        if (is_null($react_type)) {
            throw new \InvalidArgumentException('non-nullable react_type cannot be null');
        }
        $this->container['react_type'] = $react_type;
     ...
     * @return bool
     */
    public function getIsUndo()
    {
        return $this->container['is_undo'];
    }

    /**
     * Sets is_undo
     *
     * @param bool $is_undo is_undo
     *
     * @return self
     */
    public function setIsUndo($is_undo)
    {
        if (is_null($is_undo)) {
            throw new \InvalidArgumentException('non-nullable is_undo cannot be null');
        }
        $this->container['is_undo'] = $is_undo;
